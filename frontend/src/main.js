...
pluralCaseList.push( {plural: "spaces/spaces", pascal: "SpaceSpace"} )

pluralCaseList.push( {plural: "reserves/facilities", pascal: "ReserveFacility"} )


pluralCaseList.push( {plural: "analyses/analyses", pascal: "AnalysisAnalysis"} )
